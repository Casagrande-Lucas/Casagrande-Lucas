...
📌 **Funcionalidades:** Modularidade para adicionar novos brokers com apenas dois arquivos: configurações de API e imlpementação da classe que implementa a interface Broker.
